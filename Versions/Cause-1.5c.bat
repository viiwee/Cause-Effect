...
del /q "C:\users\%username%\temp\roomC.txt"
goto yes
:ClearAll
findstr /i "$Room" %txt% > "C:\users\%username%\temp\roomC.txt"
type "C:\users\%username%\temp\roomC.txt" > %txt%
del /q "C:\users\%username%\temp\roomC.txt"
goto yes
:CMD
...
set RoomPCounter=1
Set TimeOutNum=2
findstr /i "$RP" %txt% > "C:\users\%username%\temp\RoomPs.txt"
