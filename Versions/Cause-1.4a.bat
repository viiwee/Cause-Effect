...
if "%ConfigLast%"=="%ConfigLineU%" goto Yes
goto ConfigSearch
:ConfigFound
color %K%
goto Yes
...
Icacls %Txt1% /remove:d %UID%
Icacls Updates\* /grant %UID%:(R)
Icacls %IDFile% /Grant %UID%:(F)
Icacls %Txt2% /Grant %UID%:(F)
Icacls %Txt1% /grant %UID%:(F)
Icacls %KickFile% /grant %UID%:(F)
Icacls %cfg% /grant %UID%:(F)
goto AddAllSearch
